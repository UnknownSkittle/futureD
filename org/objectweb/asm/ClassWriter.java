...
extends ClassVisitor {
    ...
    public final MethodVisitor visitMethod(int n2, String string, String string2, String string3, String[] stringArray) {
        return new MethodWriter(this, n2, string, string2, string3, stringArray, this.F);
    }
    ...
    Item a(int n2, String string, String string2, String string3, boolean bl2) {
        ...
        if (item == null) {
            if (n2 <= 4) {
                ...
                this.b(15, n2, this.newMethod(string, string2, string3, bl2));
            }
    ...
    public int newHandle(int n2, String string, String string2, String string3, boolean bl2) {
