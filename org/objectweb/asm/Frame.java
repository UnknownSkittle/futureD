...
class Frame {
    ...
    final void a(ClassWriter classWriter, int n2, Object[] objectArray, int n3, Object[] objectArray2) {
        int n4 = Frame.a(classWriter, n2, objectArray, this.c);
        ...
        this.d = new int[n3 + n5];
        Frame.a(classWriter, n3, objectArray2, this.d);
        this.g = 0;
        this.h = 0;
    }

    private static int a(ClassWriter classWriter, int n2, Object[] objectArray, int[] nArray) {
        int n3 = 0;
        for (int i2 = 0; i2 < n2; ++i2) {
            if (objectArray[i2] instanceof Integer) {
                nArray[n3++] = 0x1000000 | (Integer)objectArray[i2];
                if (objectArray[i2] != Opcodes.LONG && objectArray[i2] != Opcodes.DOUBLE) continue;
                nArray[n3++] = 0x1000000;
                continue;
            }
            nArray[n3++] = objectArray[i2] instanceof String ? Frame.b(classWriter, Type.getObjectType((String)objectArray[i2]).getDescriptor()) : 0x1800000 | classWriter.a("", ((Label)objectArray[i2]).c);
        }
        return n3;
    }

    final void b(Frame frame) {
        this.c = frame.c;
        this.d = frame.d;
        this.e = frame.e;
        this.f = frame.f;
    ...
    final void a(ClassWriter classWriter, int n2, Type[] typeArray, int n3) {
        this.c = new int[n3];
        this.d = new int[0];
        int n4 = 0;
        if ((n2 & 8) == 0) {
            this.c[n4++] = (n2 & 0x80000) == 0 ? 0x1700000 | classWriter.c(classWriter.I) : 0x1000006;
        }
    ...
    final boolean a(ClassWriter classWriter, Frame frame, int n2) {
        int n3;
        int n4;
        int n5;
        int n6;
        ...
        if ((n5 & 0xFF00000) == 0x1700000 || (n5 & 0xF0000000) != 0) {
            ...
            if ((n2 & 0xFFF00000) == (n5 & 0xFFF00000)) {
                if ((n5 & 0xFF00000) == 0x1700000) {
                    n4 = n2 & 0xF0000000 | 0x1700000 | classWriter.a(n2 & 0xFFFFF, n5 & 0xFFFFF);
                } else {
                    int n6 = -268435456 + (n5 & 0xF0000000);
                    n4 = n6 | 0x1700000 | classWriter.c("java/lang/Object");
                }
                ...
                n4 = Math.min(n7, n8) | 0x1700000 | classWriter.c("java/lang/Object");
            } else {
                n4 = 0x1000000;
            }
        } else {
