...
extends LocalVariablesSorter {
    ...
    public RemappingMethodAdapter(int n2, String string, MethodVisitor methodVisitor, Remapper remapper) {
        this(327680, n2, string, methodVisitor, remapper);
    }

    protected RemappingMethodAdapter(int n2, int n3, String string, MethodVisitor methodVisitor, Remapper remapper) {
        super(n2, n3, string, methodVisitor);
