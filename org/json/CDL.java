...
public class CDL {
    ...
    public static JSONArray toJSONArray(JSONArray names, JSONTokener x2) throws JSONException {
        ...
        JSONArray ja2 = new JSONArray();
        while ((jo2 = CDL.rowToJSONObject(names, x2)) != null) {
            ja2.put(jo2);
        }
        if (ja2.length() == 0) {
            return null;
    ...
    public static String toString(JSONArray ja2) throws JSONException {
        JSONArray names;
        JSONObject jo2 = ja2.optJSONObject(0);
        if (jo2 != null && (names = jo2.names()) != null) {
    ...
    public static String toString(JSONArray names, JSONArray ja2) throws JSONException {
        ...
        StringBuffer sb = new StringBuffer();
        for (int i2 = 0; i2 < ja2.length(); ++i2) {
            JSONObject jo2 = ja2.optJSONObject(i2);
            if (jo2 == null) continue;
            sb.append(CDL.rowToString(jo2.toJSONArray(names)));
        }
        return sb.toString();
    }
}
