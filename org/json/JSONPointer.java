    ...
    private Object readByIndexToken(Object current, String indexToken) throws JSONPointerException {
        try {
            ...
            try {
                ...
                throw new JSONPointerException("Error reading value at index position " + index, e2);
            }
        } catch (NumberFormatException e3) {
            throw new JSONPointerException(String.format("%s is not an array index", indexToken), e3);
        }
    }
