...
public final class aj {
    static final int[] a = new int[]{-1, -1, -1, 0, 0, 0, 1, -1};
    private static int[] b = new int[]{1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};
    ...
    public static void c(int[] nArray, int[] nArray2) {
        ...
        long l16 = l8 + l9;
        long l17 = l15 - l10;
        long l18 = 0L + (((long)nArray[0] & 0xFFFFFFFFL) - l13 - l17);
        nArray2[0] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[1] & 0xFFFFFFFFL) + l11 - l14 - l16);
        nArray2[1] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[2] & 0xFFFFFFFFL) + l12 - l15);
        nArray2[2] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[3] & 0xFFFFFFFFL) + (l13 << 1) + l17 - l16);
        nArray2[3] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[4] & 0xFFFFFFFFL) + (l14 << 1) + l8 - l11);
        nArray2[4] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[5] & 0xFFFFFFFFL) + (l15 << 1) - l12);
        nArray2[5] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[6] & 0xFFFFFFFFL) + (l16 << 1) + l17);
        nArray2[6] = (int)l18;
        l18 = (l18 >> 32) + (((long)nArray[7] & 0xFFFFFFFFL) + (l9 << 1) + l2 - l12 - l14);
        nArray2[7] = (int)l18;
        aj.a((int)((l18 >> 32) + 6L), nArray2);
    }
    ...
    public static void a(int n2, int[] nArray) {
        ...
        if (n2 != 0) {
            ...
            l2 = (l2 >> 32) + (((long)nArray[7] & 0xFFFFFFFFL) + l3);
            nArray[7] = (int)l2;
            l2 >>= 32;
        }
        if (l2 != 0L || nArray[7] == -1 && h.d(nArray, a)) {
            aj.a(nArray);
        }
    }
    ...
    public static void d(int[] nArray, int[] nArray2, int[] nArray3) {
        if (h.g(nArray, nArray2, nArray3) != 0) {
            ...
            l2 = (l2 >> 32) + (((long)nArray[7] & 0xFFFFFFFFL) - 1L);
            nArray[7] = (int)l2;
        }
    }
