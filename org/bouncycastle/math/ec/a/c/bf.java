...
extends r {
    ...
    public bf(d d2, j j2, j j3, boolean bl2) {
        super(d2, j2, j3);
        if (j2 == null != (j3 == null)) {
    ...
    bf(d d2, j j2, j j3, j[] jArray, boolean bl2) {
    ...
    public final p b(p object) {
        ...
        if (((j)object2).j()) {
            ...
            if (((j)(object2 = ((j)object).e().a((j)object).a(j2).a(d2.g()))).j()) {
                return new bf(d2, (j)object2, d2.h().g(), this.e);
            }
        ...
        return new bf(d2, (j)object2, (j)object, new j[]{j2}, this.e);
    }
    ...
    public final p s() {
        ...
        if ((j3 = j3.e().a(j5).a(j7)).j()) {
            return new bf(d2, j3, d2.h().g(), this.e);
        }
        j7 = j3.e();
        j6 = bl2 ? j3 : j3.c(j6);
        j2 = (bl2 ? j2 : j2.c(j4)).a(j3, j5).a(j7).a(j6);
        return new bf(d2, j7, j2, new j[]{j6}, this.e);
    }
    ...
    public final p c(p object) {
        ...
        if (j2.j()) {
            return new bf(d2, j2, d2.h().g(), this.e);
        }
        object = j2.e().c(j3);
        j3 = j2.c(j6).c(j8);
        j2 = j2.a(j6).e().b(j4, j5, j3);
        return new bf(d2, (j)object, j2, new j[]{j3}, this.e);
    }
    ...
    public final p r() {
        ...
        j j3 = this.c;
        j j4 = this.d[0];
        return new bf(this.a, j2, j3.a(j4), new j[]{j4}, this.e);
    }
}
