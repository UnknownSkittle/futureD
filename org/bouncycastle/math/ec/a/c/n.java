...
extends s {
    ...
    public n(d d2, j j2, j j3, boolean bl2) {
        super(d2, j2, j3);
        if (j2 == null != (j3 == null)) {
    ...
    n(d d2, j j2, j j3, j[] jArray, boolean bl2) {
    ...
    public final p b(p jArray) {
        ...
        return new n(d2, (j)object, (j)object3, jArray, this.e);
    }
    ...
    public final p s() {
        ...
        l.d(m3.f, nArray3, object);
        int[] nArray4 = object2;
        l.a(m3.f, nArray3, nArray4);
        l.b(nArray4, object, nArray4);
        l.a(org.bouncycastle.jcajce.provider.c.a.b(nArray4, nArray4, nArray4), nArray4);
        nArray3 = nArray;
        l.b(nArray, m3.f, nArray3);
        l.a(ab.d(5, nArray3, 0), nArray3);
        l.a(ab.b(5, nArray2, 0, object), object);
        m3 = new m(nArray2);
        l.d(nArray4, m3.f);
        l.d(m3.f, nArray3, m3.f);
        l.d(m3.f, nArray3, m3.f);
        object2 = new m(nArray3);
        l.d(nArray3, m3.f, object2.f);
        l.b(object2.f, nArray4, object2.f);
        l.d(object2.f, object, object2.f);
        object = new m(nArray4);
        l.e(m2.f, object.f);
        if (!bl2) {
            l.b(object.f, m4.f, object.f);
        }
        return new n(d2, m3, (j)object2, new j[]{object}, this.e);
    }
    ...
    public final p r() {
        ...
        return new n(this.a, this.b, this.c.d(), this.d, this.e);
    }
}
