...
extends r {
    ...
    public cd(d d2, j j2, j j3, boolean bl2) {
        super(d2, j2, j3);
        if (j2 == null != (j3 == null)) {
    ...
    cd(d d2, j j2, j j3, j[] jArray, boolean bl2) {
    ...
    public final p b(p object) {
        ...
        if (((j)object2).j()) {
            ...
            if (((j)(object2 = ((j)object).e().a((j)object).a(j2))).j()) {
                return new cd(d2, (j)object2, d2.h(), this.e);
            }
        ...
        return new cd(d2, (j)object2, (j)object, new j[]{j2}, this.e);
    }
    ...
    public final p s() {
        ...
        if (j6.j()) {
            return new cd(d2, j6, d2.h(), this.e);
        }
        j j7 = j6.e();
        j j8 = bl2 ? j6 : j6.c(j5);
        j2 = j3.a(j2).e();
        ...
        return new cd(d2, j7, j2, new j[]{j8}, this.e);
    }
    ...
    public final p c(p object) {
        ...
        if (j2.j()) {
            return new cd(d2, j2, d2.h(), this.e);
        }
        object = j2.e().c(j3);
        j3 = j2.c(j6).c(j8);
        j2 = j2.a(j6).e().b(j4, j5, j3);
        return new cd(d2, (j)object, j2, new j[]{j3}, this.e);
    }
    ...
    public final p r() {
        ...
        j j3 = this.c;
        j j4 = this.d[0];
        return new cd(this.a, j2, j3.a(j4), new j[]{j4}, this.e);
    }
}
