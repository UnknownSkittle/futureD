...
public class KeyBasedFileProcessor {
    private static void a(InputStream object, InputStream object2, char[] cArray, String string) {
        ...
        try {
            ...
            if ((object = new org.bouncycastle.openpgp.a.a((InputStream)object).a()) instanceof org.bouncycastle.openpgp.a) {
                object = (org.bouncycastle.openpgp.a)object;
                object = new org.bouncycastle.openpgp.a.a(((org.bouncycastle.openpgp.a)object).a()).a();
            }
    ...
    private static void a(String object, String object2, String object3, boolean bl2, boolean bl3) {
        block4: {
            ...
            try {
                ...
                j2.a(new x((ab)object4).a("BC"));
                object4 = j2.a((OutputStream)object2, ((Object)object3).length);
    ...
    public static void main(String[] object) {
        ...
        if (object[0].equals("-e")) {
            if (object[1].equals("-a") || object[1].equals("-ai") || object[1].equals("-ia")) {
                KeyBasedFileProcessor.a(object[2] + ".asc", object[2], object[3], true, object[1].indexOf(105) > 0);
                return;
            }
            if (object[1].equals("-i")) {
                KeyBasedFileProcessor.a(object[2] + ".bpg", object[2], object[3], false, true);
                return;
            }
            KeyBasedFileProcessor.a(object[1] + ".bpg", object[1], object[2], false, false);
            return;
        }
        if (object[0].equals("-d")) {
            ...
            KeyBasedFileProcessor.a((InputStream)object, (InputStream)object2, cArray, string);
