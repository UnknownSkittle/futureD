    ...
    protected final void checkConstraints(ExecutableElement method, AnnotationHandle annotation) {
        try {
            ...
            try {
                ...
                this.ap.printMessage(Diagnostic.Kind.ERROR, ex2.getMessage(), method, annotation.asMirror());
            }
        } catch (InvalidConstraintException ex3) {
            this.ap.printMessage(Diagnostic.Kind.WARNING, ex3.getMessage(), method, annotation.asMirror());
        }
    }
