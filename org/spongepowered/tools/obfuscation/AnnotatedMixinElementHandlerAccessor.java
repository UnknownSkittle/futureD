...
implements IMixinContext {
    ...
    private void registerAccessorForTarget(AnnotatedElementAccessor elem, TypeHandle target) {
        ...
        try {
            ...
            elem.printMessage(this.ap, Diagnostic.Kind.ERROR, "Mapping conflict for @Accessor target " + elem + ": " + ex2.getNew() + " for target " + target + " conflicts with existing mapping " + ex2.getOld());
        }
    }
    ...
    private void registerInvokerForTarget(AnnotatedElementInvoker elem, TypeHandle target) {
        ...
        try {
            ...
            elem.printMessage(this.ap, Diagnostic.Kind.ERROR, "Mapping conflict for @Invoker target " + elem + ": " + ex2.getNew() + " for target " + target + " conflicts with existing mapping " + ex2.getOld());
        }
    }
