    ...
    private ITweaker initFMLCoreMod() {
        try {
            try {
                ...
                MixinPlatformAgentAbstract.logger.info("FML platform manager could not load class {}. Proceeding without FML support.", new Object[]{ex2.getMessage()});
                return null;
            }
            ...
            MixinPlatformAgentAbstract.logger.catching((Throwable)ex3);
            return null;
        }
    }
