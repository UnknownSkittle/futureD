...
extends SignatureVisitor {
    ...
    protected CheckSignatureAdapter(int api2, int type, SignatureVisitor sv) {
        super(api2);
        this.type = type;
        this.state = 1;
        this.sv = sv;
    ...
    public SignatureVisitor visitClassBound() {
        ...
        this.state = 4;
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitClassBound();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitInterfaceBound() {
        ...
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitInterfaceBound();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitSuperclass() {
        ...
        this.state = 8;
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitSuperclass();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitInterface() {
        ...
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitInterface();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitParameterType() {
        ...
        this.state = 16;
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitParameterType();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitReturnType() {
        ...
        this.state = 32;
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitReturnType();
        CheckSignatureAdapter cv2 = new CheckSignatureAdapter(2, v2);
        cv2.canBeVoid = true;
        return cv2;
    }
    ...
    public SignatureVisitor visitExceptionType() {
        ...
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitExceptionType();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitArrayType() {
        ...
        this.state = 64;
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitArrayType();
        return new CheckSignatureAdapter(2, v2);
    }
    ...
    public SignatureVisitor visitTypeArgument(char wildcard) {
        ...
        SignatureVisitor v2 = this.sv == null ? null : this.sv.visitTypeArgument(wildcard);
        return new CheckSignatureAdapter(2, v2);
    }
