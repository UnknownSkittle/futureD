...
public abstract class Printer {
    ...
    static {
        ...
        while ((l2 = s2.indexOf(44, j2)) > 0) {
            Printer.OPCODES[i2++] = j2 + 1 == l2 ? null : s2.substring(j2, l2);
            j2 = l2 + 1;
        }
        ...
        i2 = 4;
        while ((l2 = s2.indexOf(44, j2)) > 0) {
            Printer.TYPES[i2++] = s2.substring(j2, l2);
            j2 = l2 + 1;
        }
        s2 = "H_GETFIELD,H_GETSTATIC,H_PUTFIELD,H_PUTSTATIC,H_INVOKEVIRTUAL,H_INVOKESTATIC,H_INVOKESPECIAL,H_NEWINVOKESPECIAL,H_INVOKEINTERFACE,";
        HANDLE_TAG = new String[10];
        j2 = 0;
        i2 = 1;
        while ((l2 = s2.indexOf(44, j2)) > 0) {
            Printer.HANDLE_TAG[i2++] = s2.substring(j2, l2);
            j2 = l2 + 1;
        }
    }
}
