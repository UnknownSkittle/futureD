...
extends FieldVisitor {
    ...
    FieldWriter(ClassWriter cw2, int access, String name, String desc, String signature, Object value) {
        super(327680);
        if (cw2.firstField == null) {
            cw2.firstField = this;
        } else {
            cw2.lastField.fv = this;
        }
        cw2.lastField = this;
        this.cw = cw2;
        this.access = access;
        ...
        if (signature != null) {
            this.signature = cw2.newUTF8(signature);
        }
        if (value != null) {
            this.value = cw2.newConstItem((Object)value).index;
        }
    }
