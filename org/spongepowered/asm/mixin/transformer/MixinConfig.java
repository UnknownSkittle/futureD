...
IMixinConfig {
    ...
    void postInitialise() {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                this.logger.error(ex2.getMixin() + ": " + ex2.getMessage(), (Throwable)ex2);
    ...
    private void prepareMixins(List<String> mixinClasses, boolean suppressPlugin) {
        ...
        for (String mixinClass : mixinClasses) {
            ...
            try {
                ...
                if (this.required) {
                    throw new InvalidMixinException(mixin, "Error initialising mixin " + mixin + " - " + ex3.getClass() + ": " + ex3.getMessage(), (Throwable)ex3);
                }
                this.logger.error(ex3.getMessage(), (Throwable)ex3);
            }
        }
    ...
    static Config create(String configFile, MixinEnvironment outer) {
        try {
            ...
            MixinConfig config = new Gson().fromJson((Reader)new InputStreamReader(service.getResourceAsStream(configFile)), MixinConfig.class);
