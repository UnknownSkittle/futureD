...
implements IExtension {
    ...
    public ExtensionClassExporter(MixinEnvironment env) {
        ...
        try {
            ...
            logger.warn("Error cleaning class output directory: {}", new Object[]{ex2.getMessage()});
        }
    }
    ...
    private IDecompiler initDecompiler(MixinEnvironment env, File outputPath) {
        ...
        try {
            ...
            logger.info("Attempting to load Fernflower decompiler{}", new Object[]{as2 ? " (Threaded mode)" : ""});
            ...
            logger.info("Fernflower decompiler was successfully initialised, exported classes will be decompiled{}", new Object[]{as2 ? " in a separate thread" : ""});
            return decompiler;
        } catch (Throwable th) {
