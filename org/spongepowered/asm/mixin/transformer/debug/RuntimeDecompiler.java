...
IResultSaver {
    ...
    public RuntimeDecompiler(File outputPath) {
        ...
        if (this.outputPath.exists()) {
            try {
                ...
                this.logger.warn("Error cleaning output directory: {}", new Object[]{ex2.getMessage()});
            }
        }
    }
    ...
    public void writeMessage(String message, Throwable t2) {
        this.logger.warn("{} {}: {}", new Object[]{message, t2.getClass().getSimpleName(), t2.getMessage()});
    }

    @Override
    public void writeMessage(String message, IFernflowerLogger.Severity severity, Throwable t2) {
        this.logger.log(SEVERITY_LEVELS[severity.ordinal()], message, t2);
    }
