        ...
        switch (this.problem) {
            ...
            case BAD_LOAD: {
                ...
                while (ia.hasNext() && ib.hasNext()) {
                    ...
                    if (na instanceof VarInsnNode && nb2 instanceof VarInsnNode) {
                        VarInsnNode va2 = (VarInsnNode)na;
                        VarInsnNode vb2 = (VarInsnNode)nb2;
                        Type ta = va2.var > 0 ? argsa[va2.var - 1] : target;
                        Type tb = vb2.var > 0 ? argsb[vb2.var - 1] : target;
                        printer.kv("Target " + index, "%8s %-2d %s", Bytecode.getOpcodeName(va2), va2.var, ta);
