...
public interface ISelectionManager {
    ...
    public ISelection expand(ISelection var1, fa var2, int var3);

    public ISelection contract(ISelection var1, fa var2, int var3);

    public ISelection shift(ISelection var1, fa var2, int var3);
}
